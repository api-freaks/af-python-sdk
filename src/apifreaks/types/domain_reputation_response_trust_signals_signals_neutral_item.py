...
class DomainReputationResponseTrustSignalsSignalsNeutralItem(UniversalBaseModel):
    """
    ...
    polarity: DomainReputationResponseTrustSignalsSignalsNeutralItemPolarity = pydantic.Field()
    """
