...
class DomainReputationResponseTrustSignalsSignalsPositiveItem(UniversalBaseModel):
    """
    ...
    polarity: DomainReputationResponseTrustSignalsSignalsPositiveItemPolarity = pydantic.Field()
    """
