...
class GeolocationLookupV2ResponseTimeZone(UniversalBaseModel):
    ...
    dst_start: typing.Optional[GeolocationLookupV2ResponseTimeZoneDstStart] = pydantic.Field(default=None)
    """
    DST transition details (used for both the DST start and DST end transitions).
    """

    dst_end: typing.Optional[GeolocationLookupV2ResponseTimeZoneDstEnd] = pydantic.Field(default=None)
    """
    DST transition details (used for both the DST start and DST end transitions).
    """
